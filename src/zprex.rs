        ...
        assert_eq!(
            ...
            Zprex {
                sequence: vec![
                    ...
                    QuantifiedZprVal {
                        val: ZprVal::Group(Zprex { sequence: vec![] }),
                        repeater: Repeater::Finite(1),
                    }
                ]
            }
